<template>
    <fieldset>
           <h4 class="breadcumb"> Announcement/Archive</h4>
												...
												<div class="row ">
													...
													<div class="col-md-12  col-sm-12 col-xs-12 text-left" >
                                                         ...
                                                         <button 
                                                            ...
                                                            @click.prevent="newAnnouncement(data.value.id)">
                                                        ...
                                                        <button 
                                                            ...
                                                            style="padding:.17rem .15rem"
                                                            @click.prevent="inboxAnnouncement(data.value.id)">
												...
												<vue3-datatable :rows="rows" :columns="columns" :search="filter" :sortable="true" rowClass="cursor-pointer" class="advanced-table whitespace-nowrap">
													...
													<template #announcement="data">
                                                        <div 
                                                            class="email-item" 
                                                            @click.prevent="AnnouncementView(data)" 
                                                            :class="{'displa_message':data.value.id==form.id,'read_message':data.value.read && data.value.id!=form.id}">
    ...
    export default {
       ...
       methods: {
        newAnnouncement()
            ...
            sendAnnouncement()
            {
                let route = this.$router.resolve({ path: "/Sent-Announcement" });
                window.open(route.href,'_self');
                return;
